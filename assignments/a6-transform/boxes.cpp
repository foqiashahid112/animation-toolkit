...
public:
   ...
   void scene()
   {
      // Question 1 - B1
      vec3 d10 = vec3(-2,0,1);
      quat R10 = glm::angleAxis(0.0f, vec3(1,0,0));
      ...
      // Question 1 - B2
      vec3 d20 = vec3(4,0,2);
      quat R20 = glm::angleAxis(( float)(M_PI / 4.0), vec3(0,0,1));
      ...
      quat rotation = glm::angleAxis(0.0f, vec3(1,0,0));
      Transform FMove(rotation, displacement);
      Transform F = F10 * FMove * F20.inverse();
